...
- **b-form-datepicker/b-form-timepicker/b-nav-item-dropdown:** dropdown positioning handling (closes
  ...
  ([7ec2205](https://github.com/desikit/desikit/commit/7ec2205a96e0d14772f1ed6c047a9808a32fbf82))
...
- **b-icon:** add animated icon options (closes
  ...
  [#4948](https://github.com/desikit/desikit/issues/4948))
...
- **b-tabs:** add ability to provide custom tab button attributes (closes:
  [#4803](https://github.com/desikit/desikit/issues/4803))
...
- **b-table, b-table-lite:** new `tbody-tr-attr` prop for arbitrary row attributes (closes
  ...
  ([4acf6ed](https://github.com/desikit/desikit/commit/4acf6ed863dd5edd85897a01b099c42322097d1b))
...
- **b-pagination, b-pagination-nav:** add `pills` style option
  ([#4236](https://github.com/desikit/desikit/issues/4236))
...
- **v-b-visible:** fix type error in `componentUpdated` hook + minor docs update/fixes
  ([#4327](https://github.com/desikit/desikit/issues/4327))
...
Please refer to the [documentation](https://desikit.org/) for the latest usage and examples,
...
- **b-dropdown-\*:** ensure class bindings are placed on root element for all dropdown
  sub-components (closes [#4022](https://github.com/desikit/desikit/issues/4022))
  ([#4024](https://github.com/desikit/desikit/issues/4024))
  ([81efb89](https://github.com/desikit/desikit/commit/81efb89))
- **b-form-textarea:** handle initial auto-height when in modal, tabs, or other component with
  ...
  [#3936](https://github.com/desikit/desikit/issues/3936),
  [#3702](https://github.com/desikit/desikit/issues/3702))
  ([#3937](https://github.com/desikit/desikit/issues/3937))
  ([be3ac62](https://github.com/desikit/desikit/commit/be3ac62))
- **b-link:** only add the `nativeOn` property to componentData when rendering a router link
  ([#3976](https://github.com/desikit/desikit/issues/3976))
  ([62fb0b6](https://github.com/desikit/desikit/commit/62fb0b6))
- **b-modal:** ensure non-prop attributes are transferred to the modal outer wrapper `div` (closes
  [#3896](https://github.com/desikit/desikit/issues/3896))
  ([#3921](https://github.com/desikit/desikit/issues/3921))
  ([8bf3a55](https://github.com/desikit/desikit/commit/8bf3a55))
- **b-modal:** fix scroll to top issue when modal has `no-fade` set
  ([#4004](https://github.com/desikit/desikit/issues/4004))
  ([332b79f](https://github.com/desikit/desikit/commit/332b79f))
- **b-table, b-table-lite:** handle edge case where field slot returns no vNodes (fixes
  [#3919](https://github.com/desikit/desikit/issues/3919))
  ([#3920](https://github.com/desikit/desikit/issues/3920))
  ([a392059](https://github.com/desikit/desikit/commit/a392059))
- **b-table, b-table-lite:** render header when not always stacked mode (fixes
  [#3886](https://github.com/desikit/desikit/issues/3886))
  ([#3887](https://github.com/desikit/desikit/issues/3887))
  ([2302b31](https://github.com/desikit/desikit/commit/2302b31))
- **b-table, b-table-lite:** generate `:key` for `row-details` row based on the `primary-key` field
  value if available ([#4025](https://github.com/desikit/desikit/issues/4025))
  ([c7cb16f](https://github.com/desikit/desikit/commit/c7cb16f))
- **v-b-toggle:** don't override `role` if element has a `role` assigned
  ([#3889](https://github.com/desikit/desikit/issues/3889))
  ([5d155ba](https://github.com/desikit/desikit/commit/5d155ba))
- **tooltip, popover:** overall code refactor for better reactivity and performance (fixes:
  [#1990](https://github.com/desikit/desikit/issues/1990),
  [#2937](https://github.com/desikit/desikit/issues/2937),
  [#3480](https://github.com/desikit/desikit/issues/3480),
  [#3717](https://github.com/desikit/desikit/issues/3717),
  [#3854](https://github.com/desikit/desikit/issues/3854), closes
  [#3451](https://github.com/desikit/desikit/issues/3451))
  ([#3908](https://github.com/desikit/desikit/issues/3908))
  ([eebab43](https://github.com/desikit/desikit/commit/eebab43))

### Features v2.0.0

- **b-carousel:** add prop `no-wrap` for disabling wrapping to start/end (closes
  [#3902](https://github.com/desikit/desikit/issues/3902))
  ([#3905](https://github.com/desikit/desikit/issues/3905))
  ([2c8bd23](https://github.com/desikit/desikit/commit/2c8bd23))
- **b-dropdown:** add `role=presentation` to `<li>` elements for improved a11y
  ([#3996](https://github.com/desikit/desikit/issues/3996))
  ([464d257](https://github.com/desikit/desikit/commit/464d257))
- **b-img-lazy:** switch IntersectionObserver to use private `v-b-visible` directive
  ([#3977](https://github.com/desikit/desikit/issues/3977))
  ([249ccfa](https://github.com/desikit/desikit/commit/249ccfa))
- **b-modal:** add scoped style support when portalled (non-static modal)
  ([#3962](https://github.com/desikit/desikit/issues/3962))
  ([77ad6b9](https://github.com/desikit/desikit/commit/77ad6b9))
- **b-nav:** add card header support
  ([#3883](https://github.com/desikit/desikit/issues/3883))
  ([4046a53](https://github.com/desikit/desikit/commit/4046a53))
- **b-pagination:** if number of pages changes, try and keep current page active (closes
  [#3716](https://github.com/desikit/desikit/issues/3716))
  ([#3990](https://github.com/desikit/desikit/issues/3990))
  ([ae8ce78](https://github.com/desikit/desikit/commit/ae8ce78))
- **b-modal:** add prop for auto focusing one of the built in-buttons once `shown` (closes
  [#3945](https://github.com/desikit/desikit/issues/3945))
  ([#3979](https://github.com/desikit/desikit/issues/3979))
  ([6f2827e](https://github.com/desikit/desikit/commit/6f2827e))
- **b-table:** allow field definition properties `filterByFormatted` and `sortByFormatted` to accept
  ...
  [#3892](https://github.com/desikit/desikit/issues/3892))
  ([#3898](https://github.com/desikit/desikit/issues/3898))
  ([5492b38](https://github.com/desikit/desikit/commit/5492b38))
- **b-table:** new sorting icons using SVG, plus option to place icon on left of header cell (closes
  [#3687](https://github.com/desikit/desikit/issues/3687),
  [#3696](https://github.com/desikit/desikit/issues/3696),
  [#3918](https://github.com/desikit/desikit/issues/3918),
  [#3966](https://github.com/desikit/desikit/issues/3966))
  ([#3968](https://github.com/desikit/desikit/issues/3968))
  ([c4442f4](https://github.com/desikit/desikit/commit/c4442f4))
- **b-table:** add `filter-debounce` prop for debouncing filter updates
  ([#3891](https://github.com/desikit/desikit/issues/3891))
  ([03536a5](https://github.com/desikit/desikit/commit/03536a5))
- **b-table:** add `selectAllRows()` and `clearSelected()` to thead/tfoot slot scopes (addresses
  [#3901](https://github.com/desikit/desikit/issues/3901))
  ([#3907](https://github.com/desikit/desikit/issues/3907))
  ([86c53dd](https://github.com/desikit/desikit/commit/86c53dd))
- **b-table, b-table-lite:** switch slot name syntax to use round brackets instead of square
  brackets ([#3986](https://github.com/desikit/desikit/issues/3986))
  ([fca7bd5](https://github.com/desikit/desikit/commit/fca7bd5))
- **b-table, b-table-lite:** remove deprecated slot names, introduce new slot names
  ([#3866](https://github.com/desikit/desikit/issues/3866))
  ([249efd9](https://github.com/desikit/desikit/commit/249efd9))
- **b-table, b-table-lite:** use `aria-details` rather than `aria-describedby` when details row
  showing (addresses [#3801](https://github.com/desikit/desikit/issues/3801))
  ([#3992](https://github.com/desikit/desikit/issues/3992))
  ([f6f73c7](https://github.com/desikit/desikit/commit/f6f73c7))
- **b-table, b-table-lite:** add support for custom header attributes (closes
  [#2244](https://github.com/desikit/desikit/issues/2244))
  ([#3876](https://github.com/desikit/desikit/issues/3876))
  ([8784f31](https://github.com/desikit/desikit/commit/8784f31))
- **b-table, b-table-lite:** add new scoped slot `custom-foot` to allow user to create their own
  table footer (closes [#3960](https://github.com/desikit/desikit/issues/3960))
  ([#4027](https://github.com/desikit/desikit/issues/4027))
  ([cbeeef9](https://github.com/desikit/desikit/commit/cbeeef9))
- **b-table, b-table-lite, b-table-simple:** add `no-border-collapse` prop and SCSS
  ([#3987](https://github.com/desikit/desikit/issues/3987))
  ([253b4f6](https://github.com/desikit/desikit/commit/253b4f6))
- **b-toast:** add support for scoped styles
  ([#3963](https://github.com/desikit/desikit/issues/3963))
  ([ca1b5de](https://github.com/desikit/desikit/commit/ca1b5de))
- **tooltip, popover:** overall code refactor for better reactivity and performance (fixes:
  [#1990](https://github.com/desikit/desikit/issues/1990),
  [#2937](https://github.com/desikit/desikit/issues/2937),
  [#3480](https://github.com/desikit/desikit/issues/3480),
...
- **b-dropdown:** remove deprecated slot `text`
  ([#3868](https://github.com/desikit/desikit/issues/3868))
  ([29eb8b1](https://github.com/desikit/desikit/commit/29eb8b1))
- **b-form-group:** remove deprecated prop `horizontal` and `breakpoint`
  ([#3879](https://github.com/desikit/desikit/issues/3879))
  ([b301822](https://github.com/desikit/desikit/commit/b301822))
- **b-nav, b-nav-item-dropdown:** remove deprecated slot and props
  ([#3867](https://github.com/desikit/desikit/issues/3867))
  ([21fab35](https://github.com/desikit/desikit/commit/21fab35))
- **b-modal:** remove `BvModalEvent` deprecations
  ([#3864](https://github.com/desikit/desikit/issues/3864))
  ([90c299c](https://github.com/desikit/desikit/commit/90c299c))
- **b-table, b-table-lite:** switch slot name syntax to use round brackets instead of square
  brackets ([#3986](https://github.com/desikit/desikit/issues/3986))
  ([fca7bd5](https://github.com/desikit/desikit/commit/fca7bd5))
- **b-table, b-table-lite:** remove deprecated slot names, introduce new slot names
...
- **b-tabs:** remove deprecations
  ([#3863](https://github.com/desikit/desikit/issues/3863))
  ([0edac49](https://github.com/desikit/desikit/commit/0edac49))
- **tooltip/popover:** remove SCSS deprecations
  ([#3869](https://github.com/desikit/desikit/issues/3869))
  ([bea49d4](https://github.com/desikit/desikit/commit/bea49d4))
- **build:** remove deprecated `es/` build
  ([#3604](https://github.com/desikit/desikit/issues/3604))
  ([3828f59](https://github.com/desikit/desikit/commit/3828f59))
...
[CHANGELOG-OLD](https://github.com/desikit/desikit/blob/master/CHANGELOG-OLD.md) file.
