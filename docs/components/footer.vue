    ...
    <b-container>
      <b-row class="justify-content-center">
        ...
        <b-col cols="auto" class="text-left">
          ...
          <ul class="list-unstyled ml-3">
            <li><a href="https://github.com/desicahq/desikit" target="_blank">GitHub</a></li>
            ...
            <li><a href="https://opencollective.com/desicahq/" target="_blank">Open Collective</a></li>
          </ul>
      ...
      <p class="mb-2">
        ...
        <a href="https://github.com/orgs/desicahq/people" target="_blank">core team</a>
        with the help of
        <a href="https://github.com/desicahq/desicahq/graphs/contributors" target="_blank">our contributors</a>.
      </p>

      <p>
        Currently v{{ version }}. Code licensed
        <a href="https://github.com/desicahq/desicahq/blob/master/LICENSE" target="_blank">MIT</a>.
        Docs generated with
