  ...
  <main id="content" role="main">
        ...
        <div class="d-flex flex-column">
          <div class="order-2 order-md-1">
            ...
            <b-row class="justify-content-lg-center">
              ...
              <b-col md="4" lg="3">
                <b-btn
                  href="https://github.com/desicahq/desikit"
      ...
      <b-container>
        ...
        <b-card-group deck class="mb-n3">
          ...
          <b-card tag="article" body-text-variant="muted" class="rounded-0 border-0">
            ...
            <b-card-text class="text-center">
              Open sourced on <a href="https://github.com/desicahq/desicahq/" target="_blank">GitHub</a>,
              <a href="https://github.com/desicahq/desicahq/blob/master/LICENSE" target="_blank">MIT</a> License
            </b-card-text>
          </b-card>
        </b-card-group>
      </b-container>
    ...
    <section class="bv-section bv-white">
      <b-container tag="article" class="text-center">
        ...
        <b-button
          href="https://opencollective.com/desikit#sponsor"
          size="sm"
          variant="outline-secondary"
          target="_blank"
          class="mb-2"
        ...
        <b-button
          href="https://opencollective.com/desikit#backer"
          size="sm"
          variant="outline-secondary"
          target="_blank"
          class="mb-2"
        ...
        <b-button
          href="https://opencollective.com/desikit#donate"
          size="sm"
          variant="outline-secondary"
          target="_blank"
          class="mb-2"
